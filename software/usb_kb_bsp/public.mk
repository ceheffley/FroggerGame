...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../frogger_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is frogger_qsys
SOPC_NAME := frogger_qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8c0
SOPC_SYSID_FLAG += --sidp=0x8c0
ELF_PATCH_FLAG  += --sidp 0x8c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1588023518
SOPC_SYSID_FLAG += --timestamp=1588023518
ELF_PATCH_FLAG  += --timestamp 1588023518
